      ...
      for ($i=0; $i < count($UIDs); $i++) { 
        ...
        if(isset($marks)){ //$marks is set only if user made a formation
          ...
          if($marks['DIF-1'] === (float)0){
            if(isset($marks['DIF-R-1']) && $marks['DIF-R-1'] !== (float)0 ){
              $total += $marks['DIF-R-1'];
              unset($marks['DIF-R-1']);
            }
            elseif(isset($marks['DIF-R-2']) && $marks['DIF-R-2'] !== (float)0){
              $total += $marks['DIF-R-2'];
              unset($marks['DIF-R-2']);
            }
          }
          ...
          if($marks['CEN-1'] === (float)0){
            if(isset($marks['CEN-R-1']) && $marks['CEN-R-1'] !== (float)0 ){
              $total += $marks['CEN-R-1'];
              unset($marks['CEN-R-1']);
            }
            elseif(isset($marks['CEN-R-2']) && $marks['CEN-R-2'] !== (float)0){
              $total += $marks['CEN-R-2'];
              unset($marks['CEN-R-2']);
            }
          }
          ...
          if($marks['ATT-1'] === (float)0){
            if(isset($marks['ATT-R-1']) && $marks['ATT-R-1'] !== (float)0 ){
              $total += $marks['ATT-R-1'];
              unset($marks['ATT-R-1']);
            }
            elseif(isset($marks['ATT-R-2']) && $marks['ATT-R-2'] !== (float)0){
              $total += $marks['ATT-R-2'];
              unset($marks['ATT-R-2']);
            }
          }
